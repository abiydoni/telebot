    ...
    if (isset($response['status']) && $response['status']) {
        ...
        if (isset($pdo)) {
            try {
                ...
                $stmt = $pdo->prepare("INSERT INTO chats (sender_id, receiver_id, message, is_read, reply_to_id, created_at, updated_at) VALUES ('USER000', 'USER037', :message, '0', NULL, NOW(), NOW())");
