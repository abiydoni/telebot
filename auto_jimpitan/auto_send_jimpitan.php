...
$filePesan = 'ambil_data_jimpitan.php';

// Helper kirim ke chat group
...
if (empty($message)) {
    $message = 'Report Jimpitan - ' . date('Y-m-d H:i:s');
}


echo "\n--- Mengirim via Appsbee WA ---\n";
$targetNumber = '6285729705810-1505093181@g.us'; //120363398680818900@g.us';
