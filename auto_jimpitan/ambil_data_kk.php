...
try {
    $stmt = $pdo->query("SELECT uniqueCode AS code_id, name AS kk_name FROM users WHERE statusHubungan = 'Kepala Keluarga' AND villageId = 'village_001' ORDER BY name ASC");
